var EXPORTED_SYMBOLS = ['FlashFirebugFileIO', 'FlashFirebugDirIO'];
///////////////////////////////////////////////////
/////////////////////////////////////////////////
//
...
var FlashFirebugFileIO = {
    ...
    //another version "read". read file as UTF-8.
    readAsUtf8:function(file){
    	var data = "";
		// Read the file
    ...
    write  : function(file, data, mode, charset, bomb) {
        try {
            if (bomb == undefined) {
              bomb = false;
            }
...
// Example use:
// var dir = FlashFirebugDirIO.open('/test');
// if (dir.exists()) {
// 	alert(FlashFirebugDirIO.path(dir));
// 	var arr = FlashFirebugDirIO.read(dir, true), i;
// 	if (arr) {
...
// }
// else {
// 	var rv = FlashFirebugDirIO.create(dir);
